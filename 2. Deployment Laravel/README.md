...
![virtual-vs-physical](assets/virtual-vs-physical.png)

### Konsep Elastic Computing

Masalah baru: kebutuhan server kita tidak pasti. Kadang kita butuh yang besar, dan kadang kita butuh yang kecil. Kadang kita cuma butuh sedikit, dan kadang kita mungkin membutuhkan ratusan. 
...
![buat-database-baru](assets/buat-database-baru.png)
